...
public class ChartView implements Serializable {
    ...
    private BarChartModel initBarModel() {
        ...
        try {
            ...
            int age1m = Integer.parseInt(config.getProperty("InfantM"));
            int age2m = Integer.parseInt(config.getProperty("ChildM"));
            int age3m = Integer.parseInt(config.getProperty("TeenM"));
            int age4m = Integer.parseInt(config.getProperty("YAdultM"));
            int age5m = Integer.parseInt(config.getProperty("AdultM"));
            int age6m = Integer.parseInt(config.getProperty("OldM"));

            int age1j = Integer.parseInt(config.getProperty("InfantJ"));
            int age2j = Integer.parseInt(config.getProperty("ChildJ"));
            int age3j = Integer.parseInt(config.getProperty("TeenJ"));
            int age4j = Integer.parseInt(config.getProperty("YAdultJ"));
            int age5j = Integer.parseInt(config.getProperty("AdultJ"));
            int age6j = Integer.parseInt(config.getProperty("OldJ"));

            boys.set("До 5 години", age1m);
            boys.set("5 до 12", age2m);
            boys.set("12 до 18", age3m);
            boys.set("18 до 30", age4m);
            boys.set("30 до 70", age5m);
            boys.set("Над 70", age6m);

            girls.set("До 5 години", age1j);
            girls.set("5 до 12", age2j);
            girls.set("12 до 18", age3j);
            girls.set("18 до 30", age4j);
            girls.set("30 до 70", age5j);
            girls.set("Над 70", age6j);
    ...
    private void createBarModel() {
        ...
        barModel.setTitle("Играчи по пол и възраст");
        ...
        try {
            ...
            int muje = age1m + age2m + age3m + age4m + age5m + age6m;
            int jeni = age1j + age2j + age3j + age4j + age5j + age6j;
    ...
    private void createPieModel1() {
        try {
            ...
            Properties config = new Properties();
            config.load(inStream);
            int pc = Integer.parseInt(config.getProperty("PC"));
            int ps4 = Integer.parseInt(config.getProperty("PS4"));
            int wu = Integer.parseInt(config.getProperty("WiiU"));
            int xbox = Integer.parseInt(config.getProperty("XBOX"));

            pieModel1 = new PieChartModel();
            pieModel1.set("PC", pc);
            pieModel1.set("PS4", ps4);
            pieModel1.set("XBOX", xbox);
            pieModel1.set("Wii-U", wu);

            pieModel1.setTitle("Разпределение на платформи");
    ...
    private void createPieModel2() {
        ...
        try {
            ...
            Properties config = new Properties();
            config.load(inStream);
            int man = Integer.parseInt(config.getProperty("Muj"));
            int woman = Integer.parseInt(config.getProperty("Jena"));

            pieModel2.set("Мъже", man);
            pieModel2.set("Жени", woman);

            pieModel2.setTitle("Разпределение по пол");
